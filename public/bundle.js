...
var Decks = React.createClass({displayName: "Decks",
	render: function(){
		return (
			React.createElement("div", {className: "decks"}, 
				React.createElement("h1", null, "You have Decks!")
			)
		);
	}
});
	...
	render: function(){
		return (
			React.createElement("div", {className: "cards"}, 
				React.createElement("h1", null, "Cards, too!"), 
				React.createElement("p", null, "Oh yeah, you do.")
			)
		);
	}
});
